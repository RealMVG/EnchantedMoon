...
import net.mcreator.enchantedmoon.enchantment.ManaStealEnchantment;
...
public class EnchantedmoonModEnchantments {
	...
	public static final RegistryObject<Enchantment> MANA_STEAL = REGISTRY.register("mana_steal", () -> new ManaStealEnchantment());
}
