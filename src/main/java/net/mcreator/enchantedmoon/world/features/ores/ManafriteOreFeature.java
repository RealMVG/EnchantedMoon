...
package net.mcreator.enchantedmoon.world.features.ores;
...
public class ManafriteOreFeature extends OreFeature {
	public static ManafriteOreFeature FEATURE = null;
