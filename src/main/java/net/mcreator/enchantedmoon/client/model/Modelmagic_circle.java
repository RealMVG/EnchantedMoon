...
public class Modelmagic_circle<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("enchantedmoon", "modelmagic_circle"), "main");
	public final ModelPart Magic_Circle;
