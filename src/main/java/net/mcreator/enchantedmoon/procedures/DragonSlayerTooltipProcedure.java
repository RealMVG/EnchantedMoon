...
public class DragonSlayerTooltipProcedure {
	@OnlyIn(Dist.CLIENT)
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, ItemStack itemstack, List<Component> tooltip) {
		if (tooltip == null)
			return;
		if (itemstack.getItem() == EnchantedmoonModItems.DRAGON_SLAYER.get()) {
			tooltip.add(Component.literal("Wow, so big and amazing"));
		}
		if (itemstack.getItem() == EnchantedmoonModItems.CYBERKATANA_UNACTIVATED.get() || itemstack.getItem() == EnchantedmoonModItems.CYBERKATANA_ACTIVATED.get()) {
