...
import net.mcreator.enchantedmoon.procedures.CyberkatanaOnProcedure;
import net.mcreator.enchantedmoon.init.EnchantedmoonModTabs;

import java.util.List;

public class CyberkatanaUnactivatedItem extends SwordItem {
	public CyberkatanaUnactivatedItem() {
		super(new Tier() {
			public int getUses() {
				return 0;
			}
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		CyberkatanaOnProcedure.execute(entity);
		return ar;
	}
	...
	public InteractionResult useOn(UseOnContext context) {
		super.useOn(context);
		CyberkatanaOnProcedure.execute(context.getPlayer());
